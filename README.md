...
## **📌 기획 배경**  
대학교는 많은 건물들로 이루어져 있으며, 강의실을 찾기 위해 종이로 만들어진 위치 안내도나 1층에 부착된 도면을 참고해야 하는 번거로움이 있습니다.  
그러나 다음과 같은 문제점들이 존재합니다:  
...
**CampusFinder**는 사용자가 **어느 위치에 있더라도**, 핸드폰 앱을 통해 강의실을 **검색**하고 위치 정보를 얻을 수 있도록 제작되었습니다.  바쁜 학교생활 속에서 사용자들에게 큰 도움이 될 것입니다.  
